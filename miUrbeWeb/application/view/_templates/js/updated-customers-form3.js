...
function ValidarFormularioActualizacionForm3()
{
        ...
        document.formcustomers3.buyerphone.value != "" && document.formcustomers3.buyeremail.value != "")
    {
        ...
        var currency = document.formcustomers3.currency.value;
        var bankname = document.formcustomers3.bankname.value;
        var branch = document.formcustomers3.branch.value;
        var accountnumber = document.formcustomers3.accountnumber.value;
        var paymenttype = document.formcustomers3.paymenttype.value;
		    // var franchise = document.formcustomers3.franchise.value;
        var reference1name = document.formcustomers3.reference1name.value;
        var phonereference1 = document.formcustomers3.phonereference1.value;
        var emailreference1 = document.formcustomers3.emailreference1.value;
        var reference2name = document.formcustomers3.reference2name.value;
        var phonereference2 = document.formcustomers3.phonereference2.value;
        var emailreference2 = document.formcustomers3.emailreference2.value;
        var buyername = document.formcustomers3.buyername.value;
        var buyerphone = document.formcustomers3.buyerphone.value;
        var buyeremail = document.formcustomers3.buyeremail.value;
		    var idBuyers = document.formcustomers3.idbuyyer.value;
...
{
  if (document.formcustomers3.buyerphone.value.length < 3)
  {
