...
function ValidarFormularioCustomers4()
{
  ...
  var accesories = $("#accesories").is(":checked");
    ...
    {
        $("#avisopotentialbrand").show('slow');
        document.formcustomers4.potentialbrand.style.border = "1px solid #f22012";
    }

    if (document.formcustomers4.potentialbrand.value != "")
    {
        $("#avisopotentialbrand").hide('slow');
        document.formcustomers4.potentialbrand.style.border = "1px solid #17dd37";
    }
    ...
    if(active || swimwear || covers || kids || trunks || accesories)
    {
      ...
      if (document.formcustomers4.typebusiness.value != "" &&
          document.formcustomers4.potentialbrand.value != "" &&
          ...
          $.ajax({
            ...
            success: function(resp){
              ...
              if (resp == 1) {
                ...
                $("#avisovalidaciones4").hide('slow');
                $("#avisovalidaciones4").addClass("ocultar");
...
function ValidarLargoPotentialBrand()
{
  if (document.formcustomers4.potentialbrand.value.length < 3)
  {
      $("#avisolargopotentialbrand").show('slow');
      $("#avisopotentialbrand").hide('slow');
      document.formcustomers4.potentialbrand.style.border = "1px solid #f22012";
  }
  ...
  if(document.formcustomers4.potentialbrand.value.length >= 3)
  {
      $("#avisolargopotentialbrand").hide('slow');
      document.formcustomers4.potentialbrand.style.border = "1px solid #17dd37";
  }
}
...
{
  if (document.formcustomers4.dirbusiness1.value.length < 10)
  {
...
{
  if (document.formcustomers4.dirbusiness2.value.length < 10)
  {
...
{
  if (document.formcustomers4.dirbusiness3.value.length < 10)
  {
...
{
  if (document.formcustomers4.dirbusiness4.value.length < 10)
  {
...
{
  if (document.formcustomers4.dirbusiness5.value.length < 10)
  {
